...
public class SwipeGesture : DiscreteGesture
{
    ...
    /// <summary>
    /// Instant gesture velocity in pixels per second (pixel-adjusted)
    /// </summary>
...
public class SwipeRecognizer : DiscreteGestureRecognizer<SwipeGesture>
{
    ...
    protected override GestureRecognitionState OnRecognize( SwipeGesture gesture, FingerGestures.IFingerList touches )
    {
        if( touches.Count != RequiredFingerCount )
        {
            ...
            if( FingerGestures.ToDensityIndependentPixel( gesture.Move.magnitude ) < Mathf.Max( 1, MinDistance ) )
                return GestureRecognitionState.Failed;
        ...
        float distance = FingerGestures.ToDensityIndependentPixel( gesture.Move.magnitude );
